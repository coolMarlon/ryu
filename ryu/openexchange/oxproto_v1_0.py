...
assert (calcsize(OXP_SBP_COMPRESSED_HEADER_PACK_STR) ==
        OXP_SBP_COMPRESSED_HEADER_SIZE)
# Enum type for OXP_SBP
OXPSBP_FORWARDING_REQUEST = 1
OXPSBP_PACKET_OUT = 2
OXPSBP_FORWARDING_REPLY = 4

# Enum flags for OXP_SBP
OXPSBP_FLAGS_CARRY = 1

# OXPSBP_FORWARDING_REQUEST
OXPSBP_FORWARDING_REQUEST_PACK_STR = '!4s4sIBHB'
OXPSBP_FORWARDING_REQUEST_SIZE = 16
assert (calcsize(OXPSBP_FORWARDING_REQUEST_PACK_STR) ==
        OXPSBP_FORWARDING_REQUEST_SIZE)

# OXPSBP_FORWARDING_REPLY
OXPSBP_FORWARDING_REPLY_PACK_STR = '!4s4sIIBHB'
OXPSBP_FORWARDING_REPLY_SIZE = 20
assert (calcsize(OXPSBP_FORWARDING_REPLY_PACK_STR) ==
        OXPSBP_FORWARDING_REPLY_SIZE)

# OXPSBP_PACKET_OUT
OXPSBP_PACKET_OUT_PACK_STR = '!I'
OXPSBP_PACKET_OUT_SIZE = 4

assert (calcsize(OXPSBP_PACKET_OUT_PACK_STR) ==
        OXPSBP_PACKET_OUT_SIZE)

_REQUEST = OXPSBP_FORWARDING_REQUEST_SIZE
_REPLY = OXPSBP_FORWARDING_REPLY_SIZE
_PACKET_OUT = OXPSBP_PACKET_OUT_SIZE
_HEADER = OXP_SBP_COMPRESSED_HEADER_SIZE
OXPSBP_REQUEST_SIZE = _REQUEST + _HEADER
OXPSBP_REPLY_SIZE = _REPLY + _HEADER
OXPSBP_PKT_OUT_SIZE = _PACKET_OUT + _HEADER
